...
function computeStandings(done, courses){
  const S={}, H={}, D={}; // D : id -> [{id,name,pts,cumul,avg}] détail des points par partie
  // cumul : compte au CUMULÉ · avg : compte à la MOYENNE. Par défaut les deux.
  // Standalone → les deux · Ryder conteneur (8/1) → cumul seul · partie rattachée → avg seul.
  const detail=(id,gid,name,pts,opts={})=>{(D[id]=D[id]||[]).push({id:gid,name,pts,
    cumul:opts.cumul!==false, avg:opts.avg!==false});};
  ...
  const counts=ps=>ps.filter(isMember).length>=2;
    ...
    if(g.eventId) return;        // partie RATTACHÉE → sert au scoreboard ; ne compte PAS individuellement
    if(g.isContainer){
      // CONTENEUR Ryder CLÔTURÉ : une Ryder = 1 partie. Les parties rattachées servent au scoreboard.
      // Gagnant : 8 = 3 (composante « victoire », compte à la MOYENNE) + 5 (trophée, CUMULÉ seul).
      // Perdant : 1 (présence, CUMULÉ seul) · sa composante moyenne = 0. Une Ryder = 1 partie partout.
      const tw=[0,0];
    ...
    if(teamTournament){
      ...
      Object.entries(gp).forEach(([id,pt])=>detail(id,g.id,g.name,pt,{avg:false})); // ancien Ryder : cumulé seul
      return;
    }
...
const SEED_COURSES=[
  {id:1,name:"Golf Platja de Pals",country:"Espagne",par:73,
    ...
    tees:[{name:"Jaune", cr:72.0,slope:133,par:73,length:5980},
          {name:"Blanc", cr:73.9,slope:135,par:73},
          {name:"Bleu",  cr:68.4,slope:119,par:73,length:5419},
          {name:"Rouge", cr:67.0,slope:118,par:73}]},
  ...
  {id:13,name:"Golf de Marseille La Salette",country:"France",par:72,
    ...
    tees:[{name:"Jaune", cr:69.0,slope:135,par:72,length:5089},
          {name:"Blanc", cr:70.1,slope:141,par:72,length:5361},
          {name:"Bleu",  cr:66.5,slope:130,par:72,length:4578},
          {name:"Rouge", cr:63.6,slope:124,par:72,length:3989}]},
  {id:14,name:"Golf de Barbaroux",country:"France",par:72,
    ...
    tees:[{name:"Jaune", cr:70.8,slope:142,par:72,length:5526},
          {name:"Blanc", cr:73.1,slope:151,par:72,length:6053},
          {name:"Bleu",  cr:68.6,slope:137,par:72,length:5088},
          {name:"Rouge", cr:66.5,slope:133,par:72,length:4663}]},
  {id:15,name:"Golf International Pont Royal",country:"France",par:72,
    ...
    tees:[{name:"Jaune", cr:71.7,slope:144,par:72,length:5742},
          {name:"Blanc", cr:73.9,slope:147,par:72,length:6069},
          {name:"Bleu",  cr:69.4,slope:139,par:72,length:5266},
          {name:"Rouge", cr:66.7,slope:134,par:72,length:4726}]},
  {id:16,name:"Sainte Victoire Golf Club (Château l'Arc)",country:"France",par:70,
    ...
    tees:[{name:"Jaune", cr:69.6,slope:136,par:70,length:5287},
          {name:"Blanc", cr:72.1,slope:144,par:70,length:5817},
          {name:"Bleu",  cr:68.2,slope:133,par:70,length:4993},
          {name:"Rouge", cr:65.3,slope:127,par:70,length:4420}]},
  {id:17,name:"Golf Ouest Provence Miramas",country:"France",par:71,
    ...
    tees:[{name:"Jaune",cr:68.9,slope:124,par:71,length:5243},
          {name:"Blanc",cr:69.9,slope:134,par:71,length:5530},
          {name:"Bleu", cr:66.7,slope:119,par:71,length:4795},
          {name:"Rouge",cr:65.2,slope:116,par:71,length:4500}]},
  ...
  {id:19,name:"Golf Resort Provence Sainte-Baume (Nans)",country:"France",par:72,
    ...
    tees:[{name:"Jaune",cr:71.0,slope:125,par:72,length:5689},
          {name:"Blanc",cr:72.4,slope:130,par:72,length:5969},
          {name:"Bleu", cr:67.9,slope:119,par:72,length:5099},
          {name:"Rouge",cr:67.0,slope:116,par:72,length:4937}]},
  {id:20,name:"Golf de Servanes",country:"France",par:72,
    ...
    tees:[{name:"Jaune",cr:71.0,slope:132,par:72,length:5630},
          {name:"Blanc",cr:72.9,slope:142,par:72,length:6049},
          {name:"Bleu", cr:68.6,slope:128,par:72,length:5163},
          {name:"Rouge",cr:66.5,slope:128,par:72,length:4730}]},
  {id:21,name:"Golf de la Cabre d'Or",country:"France",par:72,
    ...
    tees:[{name:"Jaune",cr:70.4,slope:137,par:72,length:5581},
          {name:"Blanc",cr:73.0,slope:147,par:72,length:6060},
          {name:"Bleu", cr:67.3,slope:131,par:72,length:4971},
          {name:"Rouge",cr:65.1,slope:127,par:72,length:4519}]},
  {id:23,name:"Golf Dolce Frégate Provence",country:"France",par:71,
    ...
    tees:[{name:"Jaune",cr:70.4,slope:126,par:71,length:5268},
          {name:"Blanc",cr:71.9,slope:140,par:71,length:5679},
          {name:"Bleu", cr:68.4,slope:122,par:71,length:4870},
          {name:"Rouge",cr:66.3,slope:117,par:71,length:4449}]},
